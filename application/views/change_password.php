	              ...
	              <form class="user" method="post" action="">
	                <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    <input type="text" class="form-control form-control-user" id="email" placeholder="Email Address" required>
	                  </div>
	                </div>
	                <input type="hidden" id="change-password-link" data-link="<?php echo site_url('login/change_password/1');?>">
